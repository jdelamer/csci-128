*******************************************
Topic #14 -- Tuples, Dictionaries, and Sets
*******************************************
...
* The dictionary has associated the *key* ``Jean`` with the *value* ``50``.
...
.. code-block:: python
   :linenos:
    ...
    grades = [['Jean', 98], ['Bob', 86], ['Janice', 86], ['Greg', 59]]
...
* Most of the data structures we've seen so far are actually built on top of the fixed length arrays
...
* At the same time, if I was a race car driver, maybe knowing how things work under the hood could help me tweak and tune the car for the best performance. 
