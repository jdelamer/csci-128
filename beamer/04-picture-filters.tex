...
\begin{frame}{What is a Condition?}
    \begin{itemize}
        \item A \textbf{condition} is a question the computer can answer with \texttt{True} or \texttt{False}.
        ...
        \end{itemize}
        \item In Python, conditions are written with comparison operators like:
        \begin{itemize}
...
print("Done")
    ...
    \begin{itemize}
        \item The line under \texttt{if} is \textbf{indented}.
        \item It runs only if \texttt{x > 5} is \texttt{True}.
        \item \texttt{"Done"} prints every time, because it is not indented.
    \end{itemize}
\end{frame}
...
print("Check complete")
    ...
    \begin{itemize}
        \item Exactly one of the two blocks runs:
        \begin{itemize}
            \item the \texttt{if} block (when condition is \texttt{True}), or
            \item the \texttt{else} block (when condition is \texttt{False}).
        \end{itemize}
    \end{itemize}
\end{frame}
