...
\begin{frame}[fragile]{Lab: Simple Calculator}
...
\begin{frame}[fragile]{Lab: Circle Calculator}
    \textbf{Write a program that:}
    \begin{enumerate}
...
\begin{frame}{For Next Class}
    ...
    \begin{itemize}
        \item Complete the lab exercises
        \item Read Chapter 2 of the textbook
        \item Experiment with variables and input
        \item Try creating your own small programs
    \end{itemize}
    ...
    \textbf{Next session:}
    \begin{itemize}
        \item Introduction to pictures
        \item How images are represented in computers
        \item Loading and displaying images with Python
        \item Your first image manipulation!
    \end{itemize}
